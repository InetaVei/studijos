            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    <ul class="navbar-nav mr-auto">
                        <li class="nav-item {{ Request::routeIs('lecture.index') ? 'active' : '' }}"> 
                          <a href="{{ route('lecture.index') }}" class="nav-link">Lecture</a>
                      </li> 
                        <li class="nav-item {{ Request::routeIs('student.index') ? 'active' : '' }}"> 
                          <a href="{{ route('student.index') }}" class="nav-link">Student</a>
                      </li>  
